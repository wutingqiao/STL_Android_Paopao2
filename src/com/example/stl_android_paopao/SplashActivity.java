package com.example.stl_android_paopao;
...
public class SplashActivity extends BaseActivity implements
	...
	// 注册JPUSH接收服务
		...
		public static final String MESSAGE_RECEIVED_ACTION = "com.example.stl_android_paopao";
		...
		private void setTagAlias() {
			String alias = "0";//可以设置为用户的ID
			String tag = "android";//可以设置为用户所在的组
